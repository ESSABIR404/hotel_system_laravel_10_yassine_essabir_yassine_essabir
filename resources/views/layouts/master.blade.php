...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="{{URL::to('assets/img/esb/logo-no-background.png')}}">
	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo"> <img src="{{ URL::to('assets/img/esb/logo-no-background.png') }}" width="50" height="70" alt="logo"> <span class="logoclass"> </span> </a>
				<a href="{{ route('home') }}" class="logo logo-small"> <img src="{{ URL::to('assets/img/esb/logo-no-background.png') }}" alt="Logo" width="30" height="30"> </a>
			</div>
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="{{ URL::to('assets/img/esb/imgInkonnu.jpg') }}" width="31" alt="Soeng Souy"></span> </a>
					<div class="dropdown-menu">
						<div class="user-header">
							<div class="avatar avatar-sm"> <img src="{{ URL::to('assets/img/esb/imgInkonnu.jpg') }}" alt="User Image" class="avatar-img rounded-circle"> </div>
								<div class="user-text">
									<h6>{{auth()->id()}}</h6>
