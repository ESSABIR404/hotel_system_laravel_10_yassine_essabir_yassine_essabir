            ...
            <li class="{{ set_active(['home']) }}"> <a href="{{ route('home') }}"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a> </li>
                ...
                <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Booking </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        ...
                        <li><a class="{{ request()->is('form/booking/edit/*') ? 'active' : '' }}" href="{{ route('form/allbooking') }}"> Edit Booking </a></li>
                ...
                <li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Customers </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        ...
                        <li><a class="{{ request()->is('form/customer/edit/*') ? 'active' : '' }}" href="{{ route('form/allcustomers/page') }}"> Edit Customer </a></li>
                ...
                <li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Rooms </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        ...
                        <li><a class="{{ request()->is('form/room/edit/*') ? 'active' : '' }}" href="{{ route('form/allrooms/page') }}"> Edit Rooms </a></li>
                ...
                <li class="submenu">
                    ...
                    <li class="{{ set_active(['calendar']) }}"> <a  href="{{ route('calendar') }}"><i class="fas fa-calendar-alt"></i> <span >Calendar</span></a> </li>
                </li>
            </ul>
        </div>
    </div>
